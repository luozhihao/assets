...
import 'whatwg-fetch'
import { Form, Button, Select, Tabs, InputNumber } from 'antd'
...
class MainChart extends Component {
    ...
    showView2 = (event, type) => {
        ...
        let request = new Request('/chart/detail/', {
            headers,
            method: 'POST',
            credentials: 'include',
            body: JSON.stringify({
    ...
    showView3 = (event) => {
        ...
        let request = new Request('/chart/expenditure/', {
            headers,
            method: 'POST',
            credentials: 'include',
            body: JSON.stringify({
...
MainChart = Form.create()(MainChart)
